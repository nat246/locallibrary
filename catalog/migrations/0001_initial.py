...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ('id', models.UUIDField(default=uuid.UUID('155e0595-b0ca-4eea-bad9-9aea486b0fb6'), help_text='Unique ID for this particular book accross the whole library', primary_key=True, serialize=False)),
